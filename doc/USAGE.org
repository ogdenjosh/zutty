...
:   -boldAsBright   Display bold test in bright colors (default: false)
...
:   -boldAsBright   Font search path (default: /usr/share/fonts)
...
with how xterm handles bold text. Enabling this option will cause bold text
